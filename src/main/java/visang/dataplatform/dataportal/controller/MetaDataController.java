...
public class MetaDataController {
    ...
    public ResponseDto<List<TableMetaInfoDto>> getMetaDataWithSubCategory(@Valid @RequestBody MetaDataRequest metaDataSub) {
        List<TableMetaInfoDto> result = metaDataService.getMetaDataWithSubCategory(metaDataSub.getService_name(), metaDataSub.getMain_category_name(), metaDataSub.getSub_category_name(), metaDataSub.getPage_no(), metaDataSub.getAmount_per_page());
